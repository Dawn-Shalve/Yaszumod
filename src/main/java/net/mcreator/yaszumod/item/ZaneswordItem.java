...
public class ZaneswordItem extends SwordItem {
	public ZaneswordItem() {
		super(new Tier() {
			public int getUses() {
				return 100;
			}
	...
	public boolean hurtEnemy(ItemStack itemstack, LivingEntity entity, LivingEntity sourceentity) {
		...
		ZaneswordLivingEntityIsHitWithToolProcedure.execute(com.google.common.collect.ImmutableMap.<String, Object>builder().put("world", world).put("entity", entity).put("sourceentity", sourceentity).build());
		return retval;
	}
	...
	public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
		...
		list.add(Component.literal("murdered your mom"));
	}
}
